                ...
                <form action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="location" id="location" value="{{ old('location') }}"
                               class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-purple-500 focus:border-purple-500"
                               placeholder="Ex: Grand Théâtre de Dakar"
                               required>
                        @error('location')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            <label for="price" class="block text-sm font-medium text-gray-700 mb-1">Prix (FCFA) - 0 = Gratuit</label>
                    ...
                    <!-- Image -->
                    <div class="mb-4">
                        <label for="image" class="block text-sm font-medium text-gray-700 mb-1">Image de l'événement (optionnel)</label>
